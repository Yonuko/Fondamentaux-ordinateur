        ...
        <main>
            <div class="body-content">
                <div class="card skills">
                    ...
                    <div class="card-body">
                        <form class="skills-form" action="https://sacha-eghiazarian.fr/admin/skills/store" method="post">
                            <div class='skill'>
                                <input type="text" name="name" placeholder="nom du skill...">
                                <div class='skill-bar-holder'>
                                    <span class='skill-bar' aria-valuenow='50' aria-valuemin='1' aria-valuemax='100'></span>
                                </div>
                            </div>
                            <div class='slider'>
                                <input type='range' min='1' max='100' value='50' class='skill-slider'>
                                <input type='number' value='50' name='value' class='value' min='1' max='100'>
                            </div>
                            <select name="type" style="align-self: center; margin-top: 20px; width: 200px;">
                                <option value="dev">Dev</option>
                                <option value="infra">Infra</option>
                                <option value="web">Web</option>
                                <option value="other">Other</option>
                            </select>
                            <input type="submit" class="button" value="Créer" style="align-self:center; margin-top: 50px;">
                        </form>
                    </div>
                </div>
            </div>
