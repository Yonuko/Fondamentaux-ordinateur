...
<body>
            ...
            <div class="body-content">
                <div class="card projet">
                    ...
                    <div class="card-body">
                        ...
                        ?>
                        <form action="https://sacha-eghiazarian.fr/admin/projects/<?php echo $id?>/update" method="POST" enctype="multipart/form-data">
    ...
    <script src="https://sacha-eghiazarian.fr/assets/script/addTypes.js"></script>
</body>
</html>